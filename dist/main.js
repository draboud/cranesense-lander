(() => {
  ...
  var COMP_BTNS_END_RANGE_A = 4;
  var COMP_BTNS_START_RANGE_B = 5;
  var COMP_BTNS_END_RANGE_B = 6;
  ...
  var MainAllNavLinks = function(navLink, dropdownIndex2) {
    if (dropdownIndex2) {
      SetDropdownIndex(dropdownIndex2);
    } else {
      dropdownIndex2 = 0;
      SetDropdownIndex(0);
    }
  ...
  var MainInstructionsVidsEnds = function() {
    instructions_default.instructionVidTimer = setTimeout(function() {
      ...
      if (instructions_default.currentInstructionVid === instructionVidsCount && INSTRUCTION_VIDS_LOOPING) {
        instructions_default.currentInstructionVid = 0;
      } else if (instructions_default.currentInstructionVid === instructionVidsCount && !INSTRUCTION_VIDS_LOOPING) {
